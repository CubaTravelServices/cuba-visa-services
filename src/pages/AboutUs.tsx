  ...
  <div className="min-h-screen">
    ...
    <main>
      ...
      <section className="px-[6%] py-16 max-w-4xl mx-auto">
        ...
        <p className="text-navy/70 leading-relaxed mb-4">
          Cuba Travel Services is our specialized visa division, operating under an exclusive contract with US Based Airlines and the Cuban Consulate in Washington, D.C. This direct relationship allows us to process visas faster and more reliably than any other provider in the United States.
        </p>
      </section>
