...
<section className="bg-navy relative overflow-hidden">
    ...
    <div className="relative z-10 px-[6%] py-16 lg:py-20">
      ...
      <div className="text-center max-w-3xl mx-auto mb-12">
        ...
        <h1 className="font-display text-[clamp(38px,5vw,62px)] font-bold text-white leading-[1.1] mb-6 whitespace-nowrap">Apply for Your Official Cuba E-Visa Online — Secure & Fast Processing.
      </h1>
