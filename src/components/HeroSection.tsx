...
<section className="bg-navy relative overflow-hidden">
    ...
    <div className="relative z-10 px-[6%] py-16 lg:py-20">
      ...
      <div className="text-center max-w-3xl mx-auto mb-12">
        ...
        <h1 className="font-display text-[clamp(24px,3.2vw,46px)] font-bold text-white leading-[1.1] mb-6 whitespace-nowrap">Apply for Your Official Cuba E-Visa Online — Secure & Fast Processing.
      </h1>
        ...
        <div className="flex flex-wrap justify-center gap-8 mt-8">
          {[["15+", "Years in service"], ["500K+", "Visas processed"], ["3", "Airport offices"], ["~0 min", "Processing time"]].
        map(([num, label]) =>
        <div key={label}>
