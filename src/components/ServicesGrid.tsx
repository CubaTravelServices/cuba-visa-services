...
const services = [
  ...
  { icon: "📝", name: "D'Viajeros Form", desc: "Cuba's mandatory digital health and customs declaration. Completed correctly for you.", price: "From $15" },
  ...
  { icon: "🛳️", name: "Cuba Cruise Visa", desc: "Requirements differ from air travel. We ensure correct docs for your cruise line.", price: "From $85" },
