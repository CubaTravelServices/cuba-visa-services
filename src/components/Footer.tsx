...
const footerLinks = {
  ...
  airlines: ["American Airlines Cuba Visa", "Delta Airlines Cuba Visa", "Southwest Airlines Cuba Visa", "JetBlue Cuba Visa", "United Airlines Cuba Visa", "Other Airlines"]
};
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 max-w-6xl mx-auto mb-10">
      <div>
        ...
        <p className="text-sm leading-relaxed mb-3">
          Trusted Cuba visa and e-visa provider since 1999. Direct consular coordination. Physical staff at MIA airport. Cuba Travel Services is a Cuba Travel Services affiliate. We are not a government agency.
        </p>
