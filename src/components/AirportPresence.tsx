...
const airports = [
  ...
  { airline: "Southwest Airlines", code: "TPA", location: "Tampa International Airport, FL", desc: "Cuba visa service staffed at Southwest's Tampa Cuba operation. Every passenger has correct documentation before reaching the gate." },
];
