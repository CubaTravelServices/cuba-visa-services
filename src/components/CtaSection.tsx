const CtaSection = () => (
  ...
  >
    ...
    <h2 className="font-display text-4xl lg:text-5xl font-bold text-white mb-4">
      Get Your Cuba E-Visa Application Processed in 15 Minutes.
    </h2>
    <p className="text-white/55 max-w-[560px] mx-auto mb-8">
      Join travelers who trusted us with their Cuba e-visa. Instant delivery, direct consular coordination, airport support.
    </p>
